package com.example.myintent1037;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Vira Verina");
            ...
            case R.id.btn_move_activity_object:
                ...
                mPerson.setName("Vira Verina");
                mPerson.setAge(5);
                mPerson.setEmail("virav27@gmail.com");
